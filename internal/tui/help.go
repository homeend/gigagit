...
func helpContent() []contentLine {
	...
	return []contentLine{
		...
		r("n/p (stacked)", i18n.T("next / previous file header; home/end go to the top / bottom of the whole stack, and never step to another file — every file is already there")),
