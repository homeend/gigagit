...
func helpContent() []contentLine {
	...
	return []contentLine{
		...
		r("ctrl+p", "command palette — generic command launcher (↑↓/jk move, enter runs, esc closes); includes Show commit, File history, File blame, Find, Open repo, Apply patch, Git config explorer, Set up agent skills"),
