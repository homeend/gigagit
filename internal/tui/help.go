...
func helpContent() []contentLine {
	...
	return []contentLine{
		...
		r(".", "rename commit / copy commit id / Create branch here / Create worktree here / Cherry-pick here / Revert this commit / Reset to this commit (soft|mixed|hard) / Compare against working tree / Compare against staged / Compare with marked commit / Show all branches when soloed / Show as list|graph (.-menu)"),
