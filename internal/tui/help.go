...
func helpContent() []contentLine {
	...
	return []contentLine{
		...
		r("ctrl+←/→", "cycle the Branches / Remotes / Worktrees / Shelf tab"),
		...
		r(".", "rename branch / copy branch name / Solo this branch (.-menu)"),
		r("", "Solo this branch (.-menu): scope the Commits panel to this branch's commits (re-run to un-solo); Show all branches clears it"),
		h("Remotes panel"),
