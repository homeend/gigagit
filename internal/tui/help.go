...
func helpContent() []contentLine {
	...
	return []contentLine{
		...
		r("", "the ◇ Working tree / ◇ Staged rows can be marked (m) or added to the ◉ compare selection like commits — Compare with marked / Compare selection then diffs a commit against your working copy or index"),
		...
		r("home/end", "jump to top / bottom of the file; press again at the top/bottom to step to the previous / next file in the list"),
