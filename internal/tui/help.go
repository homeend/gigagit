...
func helpContent() []contentLine {
	...
	return []contentLine{
		...
		r("g", "bookmark quick-switcher: jump to / compare / paste a bookmarked file (add via the . menu anywhere a file is focused). In it (navigation-first): ↑↓/jk move, enter jumps (diffs the bookmark vs the working-tree file), p pastes to a typed path, m marks one then a second to compare, x removes (confirms), / filters, esc closes"),
