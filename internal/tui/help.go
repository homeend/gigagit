...
func helpContent() []contentLine {
	...
	return []contentLine{
		...
		r("g", "bookmark quick-switcher: jump to / compare / paste a bookmarked file (the . menu on any file offers Bookmark this file and Compare against bookmark — pick a bookmark, then diff the focused file against it). In it (navigation-first): ↑↓/jk move, enter jumps (diffs the bookmark vs the working-tree file), p pastes to a typed path, m marks one then a second to compare, x removes (confirms), / filters, esc closes"),
