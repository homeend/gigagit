...
// records through domain.LinkDesc, and the browser's "copy gg link"
...
//
// This test lives in internal/domain because domain OWNS LinkDesc (the CLI and
// the TUI both describe through it); it reaches across to read the web
// package's static asset, which is only a file read.
const (
